...
And Ported For godhackerzuserbot By @rohithaditya
© @Godhackerzuserbot """
...
BOT_IS_UP_TO_DATE = "`Master I Am up-to-date.\nThank you for Using Me.`"
...
async def deploy_start(tgbot, message, refspec, remote):
    ...
    await message.edit(
        "Updating System Is Successful Master ! Now I Am Restarting To Finish This Process Master. Try `.alive` To Check If I Am Alive \n© @Godhackerzuserbot"
    )
