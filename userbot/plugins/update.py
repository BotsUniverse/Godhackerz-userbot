...
BOT_IS_UP_TO_DATE = "`The userbot is up-to-date Master 😇.\nThank you for Using Me 🙏🙏.`"
...
async def deploy_start(tgbot, message, refspec, remote):
    ...
    await message.edit(
        "Updation Sucessfull Master ! Now Restarting To Finish This Process. Try `.alive` To Check If I Am Alive Master \n© @Godhackerzuserbot"
    )
