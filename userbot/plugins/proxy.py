...
edited for @Godhackerzuserbot
keep credits like me if u kang [o]

""" 
import os
# ----------WRITTEN BY FRIDAY[MIDHUN KM]-------------------------------------------EDITED BY @Rohithaditya------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
# ----------WRITTEN BY FRIDAY[MIDHUN KM]-------------------------------------------EDITED BY @Rohithaditya------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
GODHACKERZUSER_HTTP = "https://api.proxyscrape.com/?request=getproxies&proxytype=http&timeout=10000&country=all&ssl=all&anonymity=all"
HTTP_TXT = "**Proxy Info** \nType: __HTTPS__ \nTimeOut: __10000__ \nCountry: __All__ \nSsl: All \nAnonymity: __All__ \n[Click Here To View Or Download File Manually](https://api.proxyscrape.com/?request=getproxies&proxytype=http&timeout=10000&country=all&ssl=all&anonymity=all) \nUploaded By [GODHACKERZUSERBOT](https://github.com/rohithaditya/Godhackerz-userbot) \n**Here Is Your Proxy** 👇"
GODHACKERZUSER_SOCKS4 = "https://api.proxyscrape.com/?request=getproxies&proxytype=socks4&timeout=10000&country=all"
...
GODHACKERZUSER_SOCKS5 = "https://api.proxyscrape.com/?request=getproxies&proxytype=socks5&timeout=10000&country=all"
...
async def _(event):
    ...
    downloader = SmartDL(f"{GODHACKERZUSER_HTTP}", downloaded_file_name, progress_bar=False)
...
async def _(event):
    ...
    downloaded_file_name = os.path.join(Config.TMP_DOWNLOAD_DIRECTORY, file_name)
    downloader = SmartDL(f"{GODHACKERZUSER_SOCKS4}", downloaded_file_name, progress_bar=False)
    downloader.start(blocking=False)
...
async def _(event):
    ...
    downloaded_file_name = os.path.join(Config.TMP_DOWNLOAD_DIRECTORY, file_name)
    downloader = SmartDL(f"{GODHACKERZUSER_SOCKS5}", downloaded_file_name, progress_bar=False)
    downloader.start(blocking=False)
