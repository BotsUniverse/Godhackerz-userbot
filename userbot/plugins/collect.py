...
# @borg.on(admin_cmd(pattern="collect"))
# async def _(event):
#     if event.fwd_from:
#         return
#     start = datetime.now()
...
async def stats(
    ...
    response += f"**Wow Master You Where Admin in {admin_in_groups + admin_in_broadcast_channels} I am Very Proud To Hv A Master Like You😎** \n"
